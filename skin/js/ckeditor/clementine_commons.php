...
if (!defined('__CLEMENTINE_CKEDITOR_FILEMANAGER__')) {
    ...
    if (is_array($config) && isset($config['module_ckeditor']) && isset($config['module_ckeditor']['ckeditor_filemanager'])) {
        define('__CLEMENTINE_CKEDITOR_FILEMANAGER__',             $config['module_ckeditor']['ckeditor_filemanager']);
    } else {
